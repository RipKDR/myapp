...
class SettingsSection extends StatelessWidget {
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color:
                      (headerColor ?? GoogleTheme.googleBlue).withValues(alpha: 0.1),
          ...
          DecoratedBox(
            ...
            child: Column(
              children: items.asMap().entries.map((final entry) {
                final index = entry.key;
  ...
  Widget _buildSettingsItem(final BuildContext context, final SettingsItem item) {
    final theme = Theme.of(context);
    final colorScheme = theme.colorScheme;
...
class _PreferenceToggleState extends State<PreferenceToggle>
  ...
  @override
  void didUpdateWidget(final PreferenceToggle oldWidget) {
